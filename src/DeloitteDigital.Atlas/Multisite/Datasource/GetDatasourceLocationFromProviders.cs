...
namespace DeloitteDigital.Atlas.Multisite.Datasource
{
    public class GetDatasourceLocationFromProviders
    {
        ...
        public GetDatasourceLocationFromProviders()
        {
            ...
            _providers = new List<IDatasourceProvider> { (IDatasourceProvider) Sitecore.DependencyInjection.ServiceLocator.ServiceProvider.GetService(typeof(IDatasourceProvider)) };
        }
